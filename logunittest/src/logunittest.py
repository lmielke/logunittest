"""""
##################### logunittest_code.Joringel class documentation #####################
...
### End cmds
## CALL: python logunittest.py action -param ParamValue or psn action -param ParamValue
...
MAIN DIR: python $hot/modulePath/...   <-- for more examples check dockstrings TEST section
 - pyCall show:            logunittest.Joringel(__file__, **kwargs).show(**kwargs)
 - shellCall get_settings: logunittest.py get_settings -n globals -o pipe.table.T
 - shellCall _serve: python ./logunittest/src/logunittest.py _serve 
            -c pyCall 
            -f "~/python_venvs/packages/logunittest/logunittest/src/test/test_get.yml"
            -k testkey
            -v 2
 - shellCall get:
    python -m logunittest.src.logunittest get -c pyCall -f "~/python_venvs/packages/logunittest/logunittest/src/test/test_get.yml"-k testkey -v 2
...
import logunittest.src.flower as magic
import logunittest.src.get_soc as soc
from logunittest.src.encryption_handler import Handler as decryptor
from logunittest.src.get_creds import Creds
import logunittest.src.auth_checker as auth_checker
...
class Joringel:
    ...
    def _chkey(self, *args, key, newKey=None, **kwargs):
        ...
        *Last update: 2020-11-16*
        ...
        key: newKey
        self.safeName: ~/python_venvs/packages/logunittest/logunittest/src/test/test_ch_self_key.txt

        # FUNCTION
        pyCall: instance.chkey(allYes=True, **kwargs)
        shell_Call: python modulePath/logunittest.py chkey -f self.safeName -k key -y
    ...
    def _digest(self, *args, key=None, **kwargs):
        ...
        *Last update: 2020-11-09*
        ...
        # INPUTS
        key: testkey
        self.safeName: "~/python_venvs/packages/logunittest/logunittest/src/test/test_read.yml"
    ...
    def _serve(self, *args, **kwargs):
        ...
        *Last update: 2020-11-09*
        ...
        # INPUTS
        key: testkey
        encryptPath: "~/python_venvs/packages/logunittest/logunittest/src/test/test_read.yml"
    ...
    def _update_logunittest_appParams(self, secrets, *args, **kwargs) -> None:
